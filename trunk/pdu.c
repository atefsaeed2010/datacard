...
static int pdu_parse_sca(char ** pdu, size_t * length)
{
 ...
 */
EXPORT_DEF int pdu_build(char* buffer, size_t length, const char* csca, const char* dst, const char* msg, unsigned valid_minutes, int srr, int* sca_len)
{
	char tmp;
	int len = 0;
	int data_len;
