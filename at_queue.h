...
*/
#ifndef CHAN_DATACARD_AT_CMD_QUEUE_H_INCLUDED
#define CHAN_DATACARD_AT_CMD_QUEUE_H_INCLUDED
...
typedef struct at_queue_cmd
{
	...
	at_res_t		res;			/*!< expected responce code */
...
#define ATQ_CMD_DECLARE_ST2(cmd,res,data)	ATQ_CMD_DECLARE_STF(cmd, res, data, ATQ_CMD_FLAG_DEFAULT)
